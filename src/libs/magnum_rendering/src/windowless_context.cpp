...
struct ContextEGL
{
        ...
        : magnumGlContext_{Mn::NoCreate}, gpuDevice_{device}
    {
        ...
        // 1. Initialize EGL
        {
            ...
            TCHECK(eglDevId < numDevices) << "[EGL] Could not find an EGL device for CUDA device " << device;
            ...
            display_ = eglGetPlatformDisplayEXT(EGL_PLATFORM_DEVICE_EXT, eglDevices[eglDevId], nullptr);
            CHECK_EGL_ERROR();
        }
